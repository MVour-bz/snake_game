...
func spawn_food():
	...
	spawn_point.x = randf_range(bounds.x_min + Global.TILE_SIZE, bounds.x_max - Global.TILE_SIZE)
	spawn_point.y = randf_range(bounds.y_min + Global.TILE_SIZE, bounds.y_max - Global.TILE_SIZE)
